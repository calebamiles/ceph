...
extern void dump_content_length(RGWFormatterFlusher& flusher, uint64_t len);
extern void dump_content_length(struct req_state *s, uint64_t len);
extern void dump_etag(RGWFormatterFlusher& flusher, const char *etag, bool swift);
extern void dump_etag(struct req_state *s, const char *etag);
extern void dump_last_modified(RGWFormatterFlusher& flusher, time_t t);
extern void dump_last_modified(struct req_state *s, time_t t);
extern void abort_early(struct req_state *s, int err);
extern void dump_range(RGWFormatterFlusher& flusher, uint64_t ofs, uint64_t end, uint64_t total_size);
